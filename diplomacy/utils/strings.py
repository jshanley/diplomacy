...
TALK_COMMUNIQUE_COUNTS = 'talk_communique_counts'
TALK_HELD_MESSAGES = 'talk_held_messages'
TALK_MAX_CHARS_PER_MESSAGE = 'talk_max_chars_per_message'
TALK_MAX_COMMUNIQUE_CHARS = 'talk_max_communique_chars'
TALK_MAX_COMMUNIQUES_PER_YEAR = 'talk_max_communiques_per_year'
TALK_MAX_MESSAGES_PER_ROUND = 'talk_max_messages_per_round'
TALK_MESSAGE_COUNTS = 'talk_message_counts'
TALK_NUM_ROUNDS = 'talk_num_rounds'
TALK_ORDERS_DEADLINE = 'talk_orders_deadline'
TALK_READY = 'talk_ready'
TALK_ROUND = 'talk_round'
TALK_ROUND_DEADLINE = 'talk_round_deadline'
